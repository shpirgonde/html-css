...
const leftEl = document.querySelector('.left-box');
const rightEl = document.querySelector('.right-box');
...
const dismissMessageEl = document.querySelector('.dismiss-message');
